    ...
    {!isTrash && (
      <div
        ...
        style={{
          ...
          border: todo.done ? "none" : `1.5px solid ${c.muted}`,
...
const t = input.trim();
if (!t) return;
setTodos(p => […p, { id: Date.now(), text: t, done: false, createdAt: Date.now() }]);
setInput(””);
};
    ...
    <div ref={headerRef} style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, paddingTop: 4 }}>
          ...
          <div style={{
            ...
            maxWidth: (selectedId !== null && !showTrash) ? 116 : 0,
            opacity: (selectedId !== null && !showTrash) ? 1 : 0,
            overflow: "hidden",
      ...
      <div style={{
        ...
        {showTrash ? (
          ...
          <>
            <span>← 삭제 · → 완료</span>
            <span>{selectedId ? "↑↓ 순서변경 · ✕ 해제" : "탭 선택 · 길게 누르면 수정"}</span>
          </>
        )}
      </div>
    </div>
        ...
        <>
          ...
          <div style={{
            ...
            <input
              ...
              placeholder="할 일 추가 (Enter로 등록)"
              style={{
                flex: 1, background: "transparent", border: "none", outline: "none",
                fontSize: 15, color: c.label, fontFamily: "inherit",
                letterSpacing: "-0.01em",
              }}
            />
